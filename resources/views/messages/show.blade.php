        ...
        <aside class="space-y-6">
            ...
            <section class="rounded-[2rem] bg-white p-6 shadow-xl shadow-slate-900/5">
                ...
                <div class="mt-4 flex flex-col gap-3">
                    <a href="{{ route('messages.inbox') }}" class="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-50">Back to inbox</a>
                    <a href="{{ route('messages.sent') }}" class="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-50">View sent messages</a>
                </div>
            </section>
        </aside>
        </div>
